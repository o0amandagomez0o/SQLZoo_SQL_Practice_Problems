...
SELECT name, continent
FROM world x
WHERE 3*(population) <= ALL(SELECT population
                        FROM world y 
                        WHERE x.continent = y.continent
                        AND 
                        population > 0
                        AND 
                        y.continent = y.continent)
...
--need clarification on why reversing inequalty is necessary
...
/*
Select the code that shows the countries with a less than a third of the population of the countries around
*/                    
SELECT name, region 
FROM bbc x
...
/*
Gives the countries that have a larger population than UK and from Europe
*/
...
/*
Gives the countries from Europe and South Asia with the highest population in those two regions
*/
SELECT name FROM bbc
 WHERE population > ALL
