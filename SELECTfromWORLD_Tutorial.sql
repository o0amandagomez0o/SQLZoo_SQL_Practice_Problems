...
that have a population of at least 200 million. 200 million is 
...
Show the countries that are big by area or big by population. Show 
...
You can use the LENGTH function to find the number of characters in a 
string
*/
SELECT name,
       capital
